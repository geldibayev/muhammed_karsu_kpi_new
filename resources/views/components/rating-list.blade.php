        ...
        <div class="card card-outline card-primary">
            <div class="card-header px-4 py-3">
                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between">
                    <div class="pr-md-4">
                        <h1 class="h5 font-weight-bold mb-1">Foydalanuvchilar reytingi</h1>
            ...
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a href="{{ route($filterRoute, array_merge($filters, ['degree_group' => 'with_degree'])) }}"
                    ...
                    <li class="nav-item">
                        <a href="{{ route($filterRoute, array_merge($filters, ['degree_group' => 'without_degree'])) }}"
                ...
                <form method="GET" action="{{ route($filterRoute) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-6 d-flex align-items-end">
                            ...
                            <a href="{{ route($filterRoute, ['degree_group' => $filters['degree_group']]) }}"
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover small mb-0">
                        ...
                        @empty
                            <tr>
                                <td colspan="{{ $showActions ? 7 : 6 }}" class="text-center text-muted py-5">
