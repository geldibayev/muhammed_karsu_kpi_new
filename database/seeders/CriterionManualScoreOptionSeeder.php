...
class CriterionManualScoreOptionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $options = [
            ...
            ['criterion' => '2.1.3', 'code' => 'a1', 'label' => 'A1 sertifikat', 'point' => 0, 'sort_order' => 1],
            ['criterion' => '2.1.3', 'code' => 'a2', 'label' => 'A2 sertifikat', 'point' => 0, 'sort_order' => 2],
            ['criterion' => '2.1.3', 'code' => 'b1', 'label' => 'B1 sertifikat', 'point' => 3, 'sort_order' => 3],
            ['criterion' => '2.1.3', 'code' => 'b2', 'label' => 'B2 sertifikat', 'point' => 6, 'sort_order' => 4],
            ['criterion' => '2.1.3', 'code' => 'c1', 'label' => 'C1 sertifikat', 'point' => 8, 'sort_order' => 5],
            ['criterion' => '2.1.3', 'code' => 'c2', 'label' => 'C2 sertifikat', 'point' => 10, 'sort_order' => 6],
