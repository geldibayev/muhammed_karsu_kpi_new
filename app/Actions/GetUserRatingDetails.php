...
{
    public function __construct(private RatingMethodPresenter $ratingMethodPresenter) {}

    /**
     * @return array{
     *     report: Report|null,
     *     user: User,
     *     criterionSections: Collection<int, array{criterion: Criterion, number: int, rows: Collection<int, array{criterion: Criterion, code: string, state: string, point: float|null, pending_count: int, pending_submissions: Collection<int, Datum>, accepted_submissions: Collection<int, Datum>, cancelled_submissions: Collection<int, Datum>, evaluators: Collection<int, array{type: string, name: string}>}>}>,
     *     totalPoints: float
     * }
     */
     ...
     * @return Collection<int, array{criterion: Criterion, number: int, rows: Collection<int, array{criterion: Criterion, code: string, state: string, point: float|null, pending_count: int, pending_submissions: Collection<int, Datum>, accepted_submissions: Collection<int, Datum>, cancelled_submissions: Collection<int, Datum>, evaluators: Collection<int, array{type: string, name: string}>}>}>
     */
     ...
     * @return array{criterion: Criterion, code: string, state: string, point: float|null, pending_count: int, pending_submissions: Collection<int, Datum>, accepted_submissions: Collection<int, Datum>, cancelled_submissions: Collection<int, Datum>, evaluators: Collection<int, array{type: string, name: string}>}
     */
    private function criterionRow(
        ...
        $cancelledSubmissions = $submissions
            ...
            ->values();
        $ratingMethod = $this->ratingMethodPresenter->describe($criterion, $evaluationCategory);
    ...
    /**
     * @param  Collection<int, Datum>  $pendingSubmissions
