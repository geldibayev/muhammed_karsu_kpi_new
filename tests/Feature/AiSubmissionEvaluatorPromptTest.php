        ...
        Gemini::assertSent(
            ...
            callback: function (string $method, array $parameters): bool {
                ...
                return $method === 'generateContent'
                    ...
                    && str_contains($prompt, 'TIZIM TOMONIDAN BERILGAN ISHONCHLI FOYDALANUVCHI KONTEKSTI:')
                    && str_contains($prompt, '"author_full_name":')
                    && str_contains($prompt, 'FOYDALANUVCHI YUBORGAN ISHONCHSIZ METADATA:')
