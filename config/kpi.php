...
return [
    ...
    'ai_human_review_criterion_reviewers' => [
        ...
        '3.1.5' => $scientificPublicationsReviewerHemisId,
        '3.1.8' => $industryFundingAndUniversityProjectReviewerHemisId,
        '3.1.9' => $industryFundingAndUniversityProjectReviewerHemisId,
        '3.1.10' => $scientificPublicationsReviewerHemisId,
        '3.1.11' => '3462111204',
        '3.1.12' => env('KPI_AI_HUMAN_REVIEWER_3_1_12_HEMIS_ID', '3462111204'),
    ...
    'criterion_reviewers' => [
        ...
        '1.5' => env(
            'KPI_REVIEWER_1_5_HEMIS_ID',
            env('KPI_REVIEWER_1_7_HEMIS_ID', $primarySuperAdminHemisId),
        ),
